...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Log.d(LOG_TAG, "Status: " + mEmail+ "  "+mPassword);
            RestService restService = new RestService();
            try {
                UserLoginModel registrationModel = restService.login(mEmail, mPassword);
                Log.d(LOG_TAG, "Status: " + registrationModel.getStatus());
                if (registrationModel.getStatus().equals(ConstantManager.STATUS_SUCCEED)) {
                    Log.d(LOG_TAG, "Status: " + registrationModel.getAuthToken());
                } else if (registrationModel.getStatus().equals(ConstantManager.STATUS_LOGIN_BUSY_ALREADY)) {
                    Log.d(LOG_TAG, "Status: " + ConstantManager.STATUS_LOGIN_BUSY_ALREADY);
                }
            } catch (IOException e) {
                Log.d(LOG_TAG, "Status: " + ConstantManager.STATUS_LOGIN_BUSY_ALREADY);
